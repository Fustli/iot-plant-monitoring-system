...
def seed_device_types(session: Session, manufacturer: Manufacturer) -> list:
    ...
    device_types_data = [
        ...
        },
        {
            ...
            "communication_interface": "MQTT",
            "supported_functions": "temperature:read,humidity:read",
            "data_unit": "°C/%",
            "min_value": -40.0,
            "max_value": 100.0,
        },
        ...
        },
        {
            ...
            "communication_interface": "MQTT",
            "supported_functions": "moisture:write",
            "data_unit": "%",
            "min_value": 0.0,
            "max_value": 100.0,
        },
        {
            ...
            "communication_interface": "MQTT",
            "supported_functions": "brightness:write",
            "data_unit": "lux",
            "min_value": 0.0,
            "max_value": 10000.0,
        },
        {
            "name": "Humi Humidifier Platinum",
            "device_type": "actuator",
            "description": "Fulfills all your humidity needs.",
            "communication_interface": "MQTT",
