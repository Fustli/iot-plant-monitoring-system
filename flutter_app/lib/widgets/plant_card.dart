...
class _PlantCardState extends State<PlantCard> with TickerProviderStateMixin {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _getHealthColor(widget.plant.healthStatus),
                                  borderRadius: BorderRadius.circular(12),
                                ),
                                child: Text(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: _buildSensorTile(
                            ...
                            color: _getMoistureColor(widget.plant.currentMoisture),
                          ),
                        ),
                        ...
                        Expanded(
                          child: _buildSensorTile(
                            ...
                            label: 'Temp',
                            value: '${widget.plant.currentTemperature.toStringAsFixed(1)}°C',
  ...
  Future<void> _handleWaterPlant() async {
    ...
    try {
      // Attempt to water the plant (real or mock)
      final success = await _dataService.waterPlant(widget.plant.id);
      ...
      if (success) {
        ...
        // Update moisture level optimistically
        widget.plant.updateMoisture(
          (widget.plant.currentMoisture + 20).clamp(0, 100));
