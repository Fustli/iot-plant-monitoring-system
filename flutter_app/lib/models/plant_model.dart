...
class Plant {
  ...
  factory Plant.fromJson(Map<String, dynamic> json) {
    return Plant(
      ...
      updatedAt: json['updated_at'] != null 
          ...
          : DateTime.now(),
      imageUrl: json['image_url'] ?? 'https://via.placeholder.com/150?text=Plant',
      currentMoisture: json['current_moisture'] ?? 0,
      currentTemperature: (json['current_temperature'] ?? 0.0).toDouble(),
      currentLight: json['current_light'] ?? 0,
    );
  }
  ...
  static HealthStatus _parseHealthStatus(dynamic status) {
    ...
    if (statusStr.contains('warning') || statusStr.contains('care')) return HealthStatus.warning;
    if (statusStr.contains('critical') || statusStr.contains('danger')) return HealthStatus.critical;
