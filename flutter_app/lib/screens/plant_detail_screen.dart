...
class _PlantDetailScreenState extends State<PlantDetailScreen> {
  ...
  Future<void> _loadSensorHistory() async {
    ...
    try {
      final history = await HybridDataService().getSensorHistory(widget.plantId, 7);
      setState(() {
                    ...
                    children: [
                      ...
                      Consumer<AlertProvider>(
                        builder: (context, alertProvider, child) {
                          final plantAlerts = alertProvider.getAlertsForPlant(plant.id)
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.eco, 'Health Status', plant.healthStatus.displayName),
              ...
              children: [
                ...
                Expanded(
                  child: _buildSensorGauge(
                    ...
                    (plant.currentTemperature - 15) / 15, // Scale 15-30°C to 0-1
                    Colors.orange,
                    Icons.thermostat,
                  ),
                ),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: _isControllingLight ? null : _handleToggleLight,
                    ...
                    label: Text(_isControllingLight ? 'Adjusting...' : 'Adjust Light'),
                    style: ElevatedButton.styleFrom(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCareInstruction(Icons.water_drop, 'Water when soil moisture drops below 30%'),
            _buildCareInstruction(Icons.wb_sunny, 'Provide bright, indirect sunlight'),
            _buildCareInstruction(Icons.thermostat, 'Maintain temperature between 18-26°C'),
            _buildCareInstruction(Icons.eco, 'Monitor for pests and diseases regularly'),
          ],
        ),
      ),
    );
